...
// Новосибирск → Кемерово (→90) → Красноярск (↗45) → Иркутск (↘45)
// → Улан-Удэ (→90) → Чита (→90) → Сковородино (→90) → Благовещенск (↓90)
// → Биробиджан (→90) → Хабаровск (↓90) → Уссурийск (↓90) → Владивосток (↓90)
const NSK_FE_STATIONS = [
  "Новосибирск","Кемерово","Красноярск","Иркутск","Улан-Удэ","Чита","Сковородино","Благовещенск","Биробиджан","Хабаровск","Уссурийск","Владивосток"
];
const NSK_FE_MOVES: Move[] = ['R90','UR45','DR45','R90','R90','R90','D90','R90','D90','D90','D90'];
...
function runSelfTests(lines: LineDef[], pos: Record<string,{x:number;y:number}>){
  ...
  check('NSK-FE', NSK_FE_STATIONS.length);
